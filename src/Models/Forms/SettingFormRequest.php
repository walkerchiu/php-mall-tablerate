...
class SettingFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if ($request->isMethod('put') && isset($request->id)) {
            $rules = array_merge($rules, ['id' => ['required','string','exists:'.config('wk-core.table.mall-tablerate.settings').',id']]);
        }
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (isset($data['host_type']) && isset($data['host_id'])) {
                if ( config('wk-mall-tablerate.onoff.site') && !empty(config('wk-core.class.site.site')) && $data['host_type'] == config('wk-core.class.site.site') ) {
                ...
                } elseif ( config('wk-mall-tablerate.onoff.group') && !empty(config('wk-core.class.group.group')) && $data['host_type'] == config('wk-core.class.group.group') ) {
